...
Left or right positioning is as easy. `left` or `right` at `img style="position: absolute; top: 0; right or left: 0`
Colours are super easy too, just put your color selection (*along with position choice)* at the end of your `img src` link like this `right-red@2x.png`
